...
import { Third3Img } from "../../../assets/product";

const CollaborateLayer = () => {
  return (
    <Grid container spacing={0} alignItems="center" mt={3}>
      {/* Collaborate section Text Grid Item */}
      <Grid item xs={11} sm={7}>
        ...
        >
          <Typography sx={styles.sectionTitle}>COLLABORATE</Typography>
        </Box>
        <Box
          sx={{
...
export default CollaborateLayer;
